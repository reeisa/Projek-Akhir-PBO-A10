...
public class EditAgent extends javax.swing.JFrame {
    ...
    private int IDA = InterfaceMenu.ID;
    ...
    private void loadInput() {
        try {
            ...
            String sql = "SELECT nama,role,skill,utility,price FROM agent WHERE id_agent = " + IDA;
            stat = con.createStatement();
            res = stat.executeQuery(sql);

            if (res.next()) {
                this.txtnama.setText(res.getString("nama"));
                this.cbrole.setSelectedItem(res.getString("role"));
                this.txtskill.setText(res.getString("skill"));
                this.txtutil.setText(res.getString("utility"));
                this.txtPrice.setText(res.getString("price"));
            }
            res.close();
            stat.close();
    ...
    private void initComponents() {
        ...
        txtnama.setForeground(new java.awt.Color(102, 0, 0));
        txtnama.setText(" Nama Agent");
        txtnama.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(102, 0, 0)));
        ...
        cbrole.setForeground(new java.awt.Color(102, 0, 0));
        cbrole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Duelist", "Controller", "Sentinel", "Initiator" }));
        cbrole.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(102, 0, 0)));
        cbrole.setName(""); // NOI18N
        jPanel1.add(cbrole);
        cbrole.setBounds(100, 110, 202, 30);

        txtskill.setForeground(new java.awt.Color(102, 0, 0));
        txtskill.setText(" Skill Agent");
        txtskill.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(102, 0, 0)));
        ...
        txtPrice.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(102, 0, 0)));
        ...
        btnubah.setForeground(new java.awt.Color(255, 255, 204));
        ...
        jPanel1.add(btnubah);
        btnubah.setBounds(100, 270, 202, 30);
        ...
        jLabel1.setText("Edit Data Agent");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(140, 20, 130, 30);

        txtutil.setForeground(new java.awt.Color(102, 0, 0));
        txtutil.setText(" Utility Agent");
        txtutil.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, new java.awt.Color(102, 0, 0)));
    ...
    private void btnubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahActionPerformed
        ...
        try {
            adm.updateAgent(new Agent(IDA, nm, role, skill, util, price));
            JOptionPane.showMessageDialog(this, "Berhasil Mengubah Agent!", "SQL Information", JOptionPane.INFORMATION_MESSAGE);
            InterfaceMenu InterfaceMenu = new InterfaceMenu();
            InterfaceMenu.setVisible(true);
            dispose();
        } catch (Exception e) {
